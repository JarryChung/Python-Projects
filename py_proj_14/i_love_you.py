...
class MessageBox(QtWidgets.QWidget):
    ...
    def __init__(self, parent = None):
        ...
        # 打开图片
        self.window_pale.setBrush(self.backgroundRole(), QtGui.QBrush(QtGui.QPixmap("rose.jpg")))
        # 应用背景色
